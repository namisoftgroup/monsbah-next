      ...
      <div className="container">
        <div className="mainLinks">
          ...
          <div className="moreActions">
            ...
            {user?.id && (
              <>
                {console.log("🔔 [Header] Rendering notifications dropdown")}
            ...
            {user && userType ? (
              <>
                {console.log(
                  "✅ [Header] Authenticated user rendering profile area"
                )}
                {userType === "client" ? (
                  <>
                  ...
                  <>
                    {console.log("🏢 [Header] Rendering company dropdown")}
                    <Dropdown>
                      <Dropdown.Toggle
                        aria-label="user icon"
                        id="dropdown-basic"
              ...
              <>
                {console.log(
                  "🔐 [Header] No user detected — showing login button"
                )}
                <button
                  aria-label="Login"
                  className="link "
